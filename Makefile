...
megatape.tap: build/day1/full.tap build/day2/full.tap build/day3/full.tap build/day4/full.tap build/day5/full.tap build/day6/full.tap build/day7/full.tap
	cat $^ > $@
